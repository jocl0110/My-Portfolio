...
interface Education {
    ...
    const education: Education[] = [
        {when: "Graduated 05/2019", name: "High School", location: "Pinar del Rio, Cuba", school: "Friedrich Engels", id: 1},
        {when: "Finished 03/2022(Not Graduated)", name: "Bachelor\' Degree", location: "Havana, Cuba", school: 'University of Informatics Sciences', id: 2},
        {when: "Finished 05/2023", name: "Responsive Web Design Developer Certification", location: "Online", school: "freeCodeCamp", id: 3},
        {when: "Finished 01/26/2024", name: "Programming Basics", location: "Online", school: "Code The Dream", id: 4},
        {when: "Finished 06/27/2024", name: "React.JS", location: "Online", school: "Code The Dream", id: 5 }
    ]
    ...
    export {skills, education, learning, tabs};